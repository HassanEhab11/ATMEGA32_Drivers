...
#define PORTB_PIN4_DIR        0     /*SPI_SLAVE*/       /*******     >>    PB4  (SS)         <<    *******/
#define PORTB_PIN5_DIR        0     /*SPI_SLAVE*/       /*******     >>    PB5  (MOSI)       <<    *******/
#define PORTB_PIN6_DIR        1     /*SPI_SLAVE*/       /*******     >>    PB6  (MISO)       <<    *******/
#define PORTB_PIN7_DIR        0     /*SPI_SLAVE*/       /*******     >>    PB7  (SCK)        <<    *******/
