...
#define PORTA_PIN1_DIR        0          /** LCD Pin  RS  *******/
#define PORTA_PIN2_DIR        0         /*** LCD Pin  EN  ******/
#define PORTA_PIN3_DIR        0        /**** LCD Pin  D4  *****/
#define PORTA_PIN4_DIR        0       /***** LCD Pin  D5  ****/
#define PORTA_PIN5_DIR        0      /****** LCD Pin  D6  ***/
#define PORTA_PIN6_DIR        0     /******* LCD Pin  D7  **/
...
#define PORTD_PIN1_INITIAL_VALUE        0       /* pull up */
#define PORTD_PIN2_INITIAL_VALUE        0      /* pull up */
#define PORTD_PIN3_INITIAL_VALUE        0    /* pull up */
#define PORTD_PIN4_INITIAL_VALUE        0    /* pull up */
