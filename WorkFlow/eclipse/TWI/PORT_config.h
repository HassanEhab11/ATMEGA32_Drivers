...
#define PORTB_PIN4_DIR        0     /*SPI_MASTER*/      /*******     >>    PB4  (SS)         <<    *******/
#define PORTB_PIN5_DIR        0     /*SPI_MASTER*/      /*******     >>    PB5  (MOSI)       <<    *******/
#define PORTB_PIN6_DIR        0     /*SPI_MASTER*/      /*******     >>    PB6  (MISO)       <<    *******/
#define PORTB_PIN7_DIR        0     /*SPI_MASTER*/      /*******     >>    PB7  (SCK)        <<    *******/

#define PORTC_PIN0_DIR        0                         /*******     >>    PC0  (SCL)        <<    *******/
#define PORTC_PIN1_DIR        0                         /*******     >>    PC1  (SDA)        <<    *******/
#define PORTC_PIN2_DIR        0                         /*******     >>    PC2  (TCK)        <<    *******/
...
#define PORTB_PIN4_INITIAL_VALUE        0    /* input pulled up for master */
