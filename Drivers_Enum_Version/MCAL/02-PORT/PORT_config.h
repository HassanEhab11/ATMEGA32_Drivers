...
#define PORTA_PIN0_DIR        1            /*******     >>    PA0  (ADC0)       <<    *******/
#define PORTA_PIN1_DIR        1            /*******     >>    PA1  (ADC1)       <<    *******/
#define PORTA_PIN2_DIR        1            /*******     >>    PA2  (ADC2)       <<    *******/
#define PORTA_PIN3_DIR        1            /*******     >>    PA3  (ADC3)       <<    *******/
#define PORTA_PIN4_DIR        1            /*******     >>    PA4  (ADC4)       <<    *******/
#define PORTA_PIN5_DIR        1            /*******     >>    PA5  (ADC5)       <<    *******/
#define PORTA_PIN6_DIR        1            /*******     >>    PA6  (ADC6)       <<    *******/
#define PORTA_PIN7_DIR        1            /*******     >>    PA7  (ADC7)       <<    *******/

#define PORTB_PIN0_DIR        0            /*******     >>    PB0  (XCK/T0)     <<    *******/
#define PORTB_PIN1_DIR        0            /*******     >>    PB1  (T1)         <<    *******/
#define PORTB_PIN2_DIR        0            /*******     >>    PB2  (INT2/AIN0)  <<    *******/
#define PORTB_PIN3_DIR        1            /*******     >>    PB3  (OC0/AIN1)   <<    *******/
#define PORTB_PIN4_DIR        1            /*******     >>    PB4  (SS)         <<    *******/
#define PORTB_PIN5_DIR        1            /*******     >>    PB5  (MOSI)       <<    *******/
#define PORTB_PIN6_DIR        1            /*******     >>    PB6  (MISO)       <<    *******/
#define PORTB_PIN7_DIR        1            /*******     >>    PB7  (SCK)        <<    *******/

#define PORTC_PIN0_DIR        1            /*******     >>    PC0  (SCL)        <<    *******/
#define PORTC_PIN1_DIR        1            /*******     >>    PC1  (SDA)        <<    *******/
#define PORTC_PIN2_DIR        1            /*******     >>    PC2  (TCK)        <<    *******/
#define PORTC_PIN3_DIR        1            /*******     >>    PC3  (TMS)        <<    *******/
#define PORTC_PIN4_DIR        1            /*******     >>    PC4  (TDO)        <<    *******/
#define PORTC_PIN5_DIR        0            /*******     >>    PC5  (TDI)        <<    *******/
#define PORTC_PIN6_DIR        1            /*******     >>    PC6  (TOSC1)      <<    *******/
#define PORTC_PIN7_DIR        1            /*******     >>    PC7  (TOSC2)      <<    *******/

#define PORTD_PIN0_DIR        0            /*******     >>    PD0  (RXD)        <<    *******/
#define PORTD_PIN1_DIR        1            /*******     >>    PD1  (TXD)        <<    *******/
#define PORTD_PIN2_DIR        0            /*******     >>    PD2  (INT0)       <<    *******/
#define PORTD_PIN3_DIR        1            /*******     >>    PD3  (INT1)       <<    *******/
#define PORTD_PIN4_DIR        1            /*******     >>    PD4  (OC1B)       <<    *******/
#define PORTD_PIN5_DIR        0            /*******     >>    PD5  (OC1A)       <<    *******/
#define PORTD_PIN6_DIR        1            /*******     >>    PD6  (ICP)        <<    *******/
#define PORTD_PIN7_DIR        1            /*******     >>    PD7  (OC2)        <<    *******/
